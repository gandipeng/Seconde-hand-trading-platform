...
<%
    ...
    String tab = (String) request.getAttribute("tab"); if(tab==null) tab="pending";
...
<nav class="navbar navbar-dark bg-dark px-4">
  <a class="navbar-brand" href="<%=request.getContextPath()%>/index.jsp">民大二手 · 管理后台</a>
...
<div class="container-fluid py-4 px-4">
  ...
  <ul class="nav nav-tabs mb-4">
    <li class="nav-item"><a class="nav-link <%=\"pending\".equals(tab)?\"active\":\"\"%>" href="?tab=pending">待审核</a></li>
    <li class="nav-item"><a class="nav-link <%=\"on_sale\".equals(tab)?\"active\":\"\"%>" href="?tab=on_sale">已通过</a></li>
    <li class="nav-item"><a class="nav-link <%=\"rejected\".equals(tab)?\"active\":\"\"%>" href="?tab=rejected">已驳回</a></li>
  </ul>
    ...
    <table class="table table-hover bg-white shadow-sm align-middle">
      <thead class="table-dark">
        <tr>
          ...
          <% if(\"pending\".equals(tab)){ %><th>操作</th><% } %>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td>
            <% String img=(String)p.get("coverImageUrl"); if(img!=null&&!img.isEmpty()){ %>
              <img src="<%=img%>" width="56" height="56" style="object-fit:cover;border-radius:6px">
